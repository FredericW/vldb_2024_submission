...
if __name__ == "__main__":
    ...
    high = 1423000
    low = -11200.0
    clipped_data = income[income<=high]
    clipped_data = clipped_data[clipped_data>=low]
    """ 
    ...
    print(f'On Income Data with beta={args.beta} and bin_size={args.bin_size},averaged over {args.runs} runs')
